...
import static task5_refactoring_poker.Deck.deck;
import static task5_refactoring_poker.Deck.getDeckOfCards;
import static task5_refactoring_poker.PokerMachine.serveCards;
import static task5_refactoring_poker.PokerMachine.shuffleDeck;
...
public class NewPoker {
    ...
    public static void main(String[] args) {
        ...
        deck[0] = new String("2 of Hearts");
        deck[1] = new String("3 of Hearts");
        deck[2] = new String("4 of Hearts");
        deck[3] = new String("5 of Hearts");
        deck[4] = new String("6 of Hearts");
        deck[5] = new String("7 of Hearts");
        deck[6] = new String("8 of Hearts");
        deck[7] = new String("9 of Hearts");
        deck[8] = new String("10 of Hearts");
        deck[9] = new String("Jack of Hearts");
        deck[10] = new String("Queen of Hearts");
        deck[11] = new String("King of Hearts");
        deck[12] = new String("Ace of Hearts");
        deck[13] = new String("2 of Clubs");
        deck[14] = new String("3 of Clubs");
        deck[15] = new String("4 of Clubs");
        deck[16] = new String("5 of Clubs");
        deck[17] = new String("6 of Clubs");
        deck[18] = new String("7 of Clubs");
        deck[19] = new String("8 of Clubs");
        deck[20] = new String("9 of Clubs");
        deck[21] = new String("10 of Clubs");
        deck[22] = new String("Jack of Clubs");
        deck[23] = new String("Queen of Clubs");
        deck[24] = new String("King of Clubs");
        deck[25] = new String("Ace of Clubs");
